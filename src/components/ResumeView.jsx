            ...
            {projects.filter(p => !p.hideOnResume).map((p) => {
              ...
              return (
                <div key={p.title} className="resume-entry">
                  <div className="resume-entry-header">
                    <span className="resume-entry-role" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
                      {p.title}
                      {p.demo && (
                        <a href={p.demo} className="resume-contact-link inline-flex items-center" target="_blank" rel="noopener noreferrer" aria-label="Live Demo">
                    ...
                    <span className="resume-entry-date resume-badge-text">
                      {p.github && (
                        <a href={p.github} className="resume-contact-link inline-flex items-center" target="_blank" rel="noopener noreferrer" aria-label="GitHub Repository">
                          <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" style={{ display: 'inline-block' }}>
